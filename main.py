...
class AllSprites(pygame.sprite.Group):
    ...
    def custom_draw(self, player):
        ...
        for x in range(self.sky_num):
            ...
            self.display_surf.blit(self.bg_sky, (x_pos - self.offset.x / 2.5, 850 - self.offset.y / 2.5))
            self.display_surf.blit(self.fg_sky, (x_pos - self.offset.x / 2, 850 - self.offset.y / 2))
...
class Main:
    ...
    def run(self):
        while True:
            ...
            self.display_surf.fill((249, 131, 103))
